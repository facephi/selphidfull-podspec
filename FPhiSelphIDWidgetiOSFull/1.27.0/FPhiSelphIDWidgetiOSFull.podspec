#
#  Be sure to run `pod spec lint FPhiSelphIDWidgetiOSFull.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.name         = "FPhiSelphIDWidgetiOSFull"
    spec.version      = "1.27.0"
    ...
    spec.source       = { :git => "https://github.com/facephi/selphidfull-framework.git", :tag => "#{spec.version}" }
    ...
    spec.dependency 'FHISelphidDocumentReaderBundle', '0.27.0'
